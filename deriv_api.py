...
class DerivAPI:
    ...
    def buy_contract(self, contract_type: str, amount: float, duration: int, duration_unit: str, symbol: str, barrier: str = None):
        """Função atualizada para suportar contratos com e sem barreira (Rise/Fall)."""
        ...
        # Só adiciona a barreira se ela for fornecida (ex: para dígitos)
